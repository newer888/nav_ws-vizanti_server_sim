...
: ${AMENT_CURRENT_PREFIX:="/home/zr/code/src/install/nav2_keepout_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_keepout_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/nav2_keepout_pkg/environment/path.sh"

...
def generate_launch_description():
    ...
    urdf_tutorial_path = get_package_share_directory('robot_relate')
    defender_3a_path = get_package_share_directory('defender_3a')
    # default_model_path = defender_3a_path + '/urdf/af3aurdf20260309.urdf'

...
static const _SpeachText_Request_type_support_symbol_names_t _SpeachText_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vizanti_server, srv, SpeachText_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vizanti_server, srv, SpeachText_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vizanti_server, srv, SpeachText_Request)() {
  return &::vizanti_server::srv::rosidl_typesupport_c::SpeachText_Request_message_type_support_handle;
}
...
static const _SpeachText_Response_type_support_symbol_names_t _SpeachText_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vizanti_server, srv, SpeachText_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vizanti_server, srv, SpeachText_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vizanti_server, srv, SpeachText_Response)() {
  return &::vizanti_server::srv::rosidl_typesupport_c::SpeachText_Response_message_type_support_handle;
}
...
static const _SpeachText_type_support_symbol_names_t _SpeachText_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vizanti_server, srv, SpeachText)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vizanti_server, srv, SpeachText)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vizanti_server, srv, SpeachText)() {
  return &::vizanti_server::srv::rosidl_typesupport_c::SpeachText_service_type_support_handle;
}
